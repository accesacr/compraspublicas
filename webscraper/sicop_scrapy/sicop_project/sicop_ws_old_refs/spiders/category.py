...
from ..items import PortiaItem, CategoryItem


class CategorySpider(BasePortiaSpider):
    ...
    items = [[Item(CategoryItem, None, '.tdl', [Field('Enlace', 'a::attr(href)', [], True), Field('Categoria', '.tdl *::text', [], True)])]]
