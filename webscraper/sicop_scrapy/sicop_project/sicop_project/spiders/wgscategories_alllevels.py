...
class WgsCategoriesAllLevelsSpider(scrapy.Spider):
    name = 'wgscategories_alllevels'
    ...
    custom_settings = {
        'LOG_FILE': '/usr/src/app/sicop_project/sicop_project/spider_logs/wgscategories_alllevels_spider_2023_test_v5.log',
        'LOG_LEVEL': 'INFO'
    }
    """rules = [
        Rule(
