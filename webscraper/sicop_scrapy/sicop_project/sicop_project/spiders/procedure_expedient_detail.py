...
class ProcedureExpedientDetail(scrapy.Spider):
    name = 'procedure_expedient_detail'
    allowed_domains = ['www.sicop.go.cr']
    #global custom_count
    #custom_count = 0
    #custom_settings = {
    #    'LOG_FILE': '/usr/src/app/sicop_project/sicop_project/spider_logs/procedure_expedient_detail_spider_test.log',
    #    'LOG_LEVEL': 'INFO'
    #}
