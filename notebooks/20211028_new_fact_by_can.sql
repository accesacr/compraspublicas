...
INTO aggdata.fct_can
FROM aggdata.can AS can_c2
LEFT OUTER JOIN aggdata.reg_can AS reg ON can_c2.CantonId = reg.CantonId
LEFT OUTER JOIN aggdata.cont_can AS cont ON can_c2.CantonId = cont.CantonId
LEFT OUTER JOIN aggdata.part_can AS part ON can_c2.CantonId = part.CantonId
