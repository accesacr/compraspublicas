...
,cte_reg_x_can_x_catn2 AS (
	...
	GROUP BY LEFT(c4.[category_id], 4)
)
...
INTO aggdata.fct_catn2
FROM aggdata.catn2 AS can_c2
LEFT OUTER JOIN aggdata.reg_catn2 AS reg ON can_c2.CategoriaN2Id = reg.CategoriaN2Id
LEFT OUTER JOIN aggdata.cont_catn2 AS cont ON can_c2.CategoriaN2Id = cont.CategoriaN2Id
LEFT OUTER JOIN aggdata.part_catn2 AS part ON can_c2.CategoriaN2Id = part.CategoriaN2Id
